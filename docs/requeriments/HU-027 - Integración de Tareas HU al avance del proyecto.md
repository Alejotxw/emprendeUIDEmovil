Característica: Integración y consolidación del proyecto
  ...
  Escenario 1: Integración de ramas y verificación de commits
    ...
    Y los mensajes de commit deben ser claros
    Y los mensajes deben referenciar las Historias de Usuario completadas
    Ejemplos:
      | Mensaje de commit                                               |
