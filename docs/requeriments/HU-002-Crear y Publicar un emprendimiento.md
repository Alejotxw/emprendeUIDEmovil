...
Entonces el sistema muestra un Widget de Dashboard con tarjetas informativas que resumen el total de productos y emprendimientos registrados.
...
Entonces el sistema muestra una lista donde los productos aparecen agrupados bajo el encabezado de su respectivo Emprendimiento, reflejando la relación de uno a muchos en la interfaz.
