...
Entonces cada modelo debe incluir los métodos fromMap() (para transformar datos de la DB a objetos) y toMap() (para transformar objetos a un formato almacenable en la DB).
