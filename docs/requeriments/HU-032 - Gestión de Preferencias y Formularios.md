# Historia de Usuario – Configuración de Preferencias y Registro de Emprendimiento
...
**Y** el estado debe persistir aunque se reinicie la aplicación.
...
**Entonces** el sistema debe guardar el producto vinculado exclusivamente a ese emprendimiento.
...
**Entonces** la aplicación debe cargar el tamaño de fuente "Grande" consultando el almacenamiento local (SharedPreferences).
