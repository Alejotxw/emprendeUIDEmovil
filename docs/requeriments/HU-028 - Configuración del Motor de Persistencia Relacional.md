Característica: Integridad referencial en base de datos SQLite
  ...
  Escenario 1: Implementación de DatabaseHelper como Singleton
    ...
    Y debe garantizar una única instancia de conexión a la base de datos
  ...
  Escenario 2: Activación de claves foráneas en SQLite
    ...
    Y no debe permitir registros inconsistentes entre tablas relacionadas

  Escenario 3: Creación de tablas con relación uno a muchos
    ...
    Y la tabla products debe referenciar a entrepreneurships mediante una clave foránea
    Y la relación debe ser de uno a muchos
    Y al eliminar un emprendimiento, sus productos asociados deben eliminarse automáticamente (ON DELETE CASCADE)
