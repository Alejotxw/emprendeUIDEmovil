# Historia de Usuario - Visualización de métricas calculadas del marketplace
...
**Y** el sistema debe mostrar el total de productos registrados de manera precisa.
...
**Y** el sistema debe mostrar el precio promedio calculado correctamente en la interfaz.
...
**Y** el estado del tema debe persistirse utilizando `SharedPreferences`, garantizando que la preferencia no se pierda.
