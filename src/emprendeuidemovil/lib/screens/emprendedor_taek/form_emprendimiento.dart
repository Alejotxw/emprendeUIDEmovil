...
class _FormEmprendimientoScreenState extends State<FormEmprendimientoScreen> {
  ...
  void initState() {
    ...
    if (widget.entrepreneurship != null) {
       ...
       _services = [
          {'name': 'Ejemplo Servicio', 'description': 'Descripci贸n ejemplo', 'price': '10.00'}
       ]; 
    } else {
      _services = [
        {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                   ...
                   const SizedBox(height: 12),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _buildCategoryItem("Dise駉", Icons.brush),
                        _buildCategoryItem("Educaci髇", Icons.school),
                   ...
                   const Text("Ubicaci贸n", style: TextStyle(fontWeight: FontWeight.bold)),
                   const SizedBox(height: 8),
                   Container(
                   ...
                   // Schedule
                   const Text("Horario de Atenci贸n", style: TextStyle(fontWeight: FontWeight.bold)),
                   const SizedBox(height: 8),
                          ...
                          onPressed: () {
                             ...
                             showDialog(
                               ...
                               builder: (context) => AlertDialog(
                                 ...
                                 content: const Text("驴Est谩s seguro de que quieres eliminar este emprendimiento?"),
                                 actions: [
                                   TextButton(
  ...
  Widget _buildSchedulePicker() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("D铆as:", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
          const SizedBox(height: 8),
          Wrap(
            spacing: 8,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _buildFormInput(_serviceDescController, "Descripci贸n breve"),
          const SizedBox(height: 12),
